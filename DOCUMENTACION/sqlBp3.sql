...
-- -----------------------------------------------------
-- Table `buenasPracticas`.`bp_empresa_buenaPractica_eventos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buenasPracticas`.`bp_empresa_buenaPractica_eventos` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `buenasPracticas`.`bp_empresa_buenaPractica_eventos` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  INDEX `actividadId_empresa_buenaPractica_evento` (`criterioId` ASC),
...
-- -----------------------------------------------------
-- Table `buenasPracticas`.`bp_preguntasAutoevaluacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buenasPracticas`.`bp_preguntasAutoevaluacion` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `buenasPracticas`.`bp_preguntasAutoevaluacion` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `preguntasAutoevaluacion_buenasPracticas_idx` (`idBuenaPractica` ASC),
...
-- -----------------------------------------------------
-- Table `buenasPracticas`.`bp_empresaResultadoAutoevaluacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buenasPracticas`.`bp_empresaResultadoAutoevaluacion` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `buenasPracticas`.`bp_empresaResultadoAutoevaluacion` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `idEmpresa` INT(11) UNSIGNED NULL,
  `idPregunta` INT(11) UNSIGNED NULL,
  `respuesta` TINYINT(1) NULL COMMENT '1 -si\n0 - no\n-1 - no se',
  PRIMARY KEY (`id`),
  INDEX `empresaResultado_empresas_idx` (`idEmpresa` ASC),
  INDEX `empresaResultado_preguntasAutoevaluacion_idx` (`idPregunta` ASC),
  ...
  CONSTRAINT `empresaResultado_preguntasAutoevaluacion2`
    ...
    REFERENCES `buenasPracticas`.`bp_preguntasAutoevaluacion` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
